...
__export(runtime_config_exports, {
  default: () => runtime_config_default,
  getPocketBaseUrl: () => getPocketBaseUrl,
...
var configCache, runtime_config_default;
...
var _instance, getUrl, pb;
var init_pb_client = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\core\\pb-client.js"() {
    init_runtime_config();
    _instance = null;
...
var init_email_suggestion = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\core\\email-suggestion.js"() {
  }
});
...
var Cart, cartEventsBound, cart_default;
var init_cart = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\cart.js"() {
    init_pb_client();
    init_utils();
...
var product_detail_page_exports = {};
__export(product_detail_page_exports, {
  default: () => product_detail_page_default,
  initProductDetailPage: () => initProductDetailPage
});
function initSlider() {
...
var product_detail_page_default;
var init_product_detail_page = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\product-detail-page.js"() {
    init_cart();
    init_utils();
    product_detail_page_default = initProductDetailPage;
  }
});
...
var reviewForm, reviewList, authMessage, imageInput, imagePreview, imageCount, selectedFiles, currentProductId, activeOverlay, MAX_REVIEW_IMAGES, MAX_REVIEW_IMAGE_SIZE, ALLOWED_REVIEW_IMAGE_TYPES, Reviews, reviews_default;
var init_reviews = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\reviews.js"() {
    ...
    activeOverlay = null;
    MAX_REVIEW_IMAGES = 5;
    MAX_REVIEW_IMAGE_SIZE = 10 * 1024 * 1024;
    ALLOWED_REVIEW_IMAGE_TYPES = ["image/jpeg", "image/png", "image/gif", "image/webp"];
    Reviews = {
      init
    };
...
var qnaForm, qnaList, authMessage2, currentProductId2, qnaComposePanel, qnaFormContainer, composePanelOpen, QnA, qna_default;
var init_qna = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\qna.js"() {
    init_pb_client();
    init_utils();
    ...
    qnaList = null;
    authMessage2 = null;
    currentProductId2 = null;
    qnaComposePanel = null;
    qnaFormContainer = null;
...
var postcodeLayer, postcodeContainer, profileActionListenerBound, missingUserRedirectScheduled, carriers, Profile, profile_default;
var init_profile = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\profile.js"() {
    ...
    init_daum_postcode();
    postcodeLayer = null;
    postcodeContainer = null;
    profileActionListenerBound = false;
    missingUserRedirectScheduled = false;
    carriers = {
...
var home_products_exports = {};
__export(home_products_exports, {
  default: () => home_products_default,
  initHomeProducts: () => initHomeProducts
});
...
var SECTION_SELECTOR, WRAPPER_SELECTOR, CONTAINER_SELECTOR, LOADING_SELECTOR, CARD_WIDTH, CURRENCY, home_products_default;
var init_home_products = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\home-products.js"() {
    init_products_api();
    SECTION_SELECTOR = "[data-home-products]";
    WRAPPER_SELECTOR = "[data-home-products-wrapper]";
    CONTAINER_SELECTOR = "[data-home-products-container]";
    LOADING_SELECTOR = "[data-home-products-loading]";
    CARD_WIDTH = "clamp(15rem, 72vw, 16rem)";
    CURRENCY = "\u20A9";
    home_products_default = initHomeProducts;
  }
});

// ns-hugo-imp:C:\hugo\ex\shop\assets\js\product-list-page.js
var product_list_page_exports = {};
__export(product_list_page_exports, {
  default: () => product_list_page_default,
...
var SECTION_SELECTOR2, CONTAINER_SELECTOR2, product_list_page_default;
var init_product_list_page = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\product-list-page.js"() {
    init_products_api();
    SECTION_SELECTOR2 = "[data-product-list-page]";
    CONTAINER_SELECTOR2 = "#product-list-container";
    product_list_page_default = initProductListPage;
  }
});

// ns-hugo-imp:C:\hugo\ex\shop\assets\js\blog-reading-progress.js
var blog_reading_progress_exports = {};
__export(blog_reading_progress_exports, {
...
var init_blog_reading_progress = __esm({
  "ns-hugo-imp:C:\\hugo\\ex\\shop\\assets\\js\\blog-reading-progress.js"() {
    PROGRESS_SELECTOR = "#reading-progress";
  }
});
...
async function initCartDrawer() {
  ...
  const shopConfig = getShopConfig2();
...
async function initProductDetailModules() {
  ...
  if (productDetailRoot) {
    const { initProductDetailPage: initProductDetailPage2 } = await Promise.resolve().then(() => (init_product_detail_page(), product_detail_page_exports));
  ...
  if (reviewRoot) {
    const { Reviews: Reviews2 } = await Promise.resolve().then(() => (init_reviews(), reviews_exports));
    Reviews2.init(productId);
  }
  if (qnaRoot) {
    const { QnA: QnA2 } = await Promise.resolve().then(() => (init_qna(), qna_exports));
    QnA2.init(productId);
  }
}
